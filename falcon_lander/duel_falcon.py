...
from falcon_env import FalconLander
from falcon_env import FalconLanderContinuous
env=FalconLander()
# env = env.unwrapped
...
for i_episode in range(MAX_EPISODES):
    s = env._reset()  # (coord_x, coord_y, vel_x, vel_y, angle, angular_vel, l_leg_on_ground, r_leg_on_ground)
    ep_r = 0
    while True:
